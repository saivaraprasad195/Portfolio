...
const Hero = () => {
  return (
    <motion.section
      id="home"
      className="max-w-[1200px] mx-auto py-10 px-5 flex flex-col justify-around items-center gap-5 lg:flex-row bg-[rgba(33,36,40,0.5)] border-b-[1px] border-b-gray-500"
