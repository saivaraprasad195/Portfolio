...
const Hero = () => {
  return (
    <motion.section
      id="home"
      className="max-w-[1200px] mx-auto py-10 px-5 flex flex-col justify-around items-center gap-5 lg:flex-row bg-[rgba(33,36,40,0.5)]"
    ...
    >
          ...
          >
            ...
            >
              <svg
                ...
                className="w-[50px] h-[50px] p-3 rounded-lg"
              >
      ...
      <motion.div
        className="w-[300px] h-[400px] rounded-xl overflow-hidden shadow-lg shadow-black "
      ...
      <hr className="border-t-[2px] border-t-gray-600"/>
    </motion.section>
  );
};
